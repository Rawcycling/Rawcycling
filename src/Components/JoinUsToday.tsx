...
const JoinUsToday = () => {
  return (
    <div className="mt-[100px] flex flex-row sm:flex-col md:flex-col items-center px-[100px] sm:px-[10px] md:px-[50px] gap-[100px]">
      <img src={icon} alt="" />
      ...
      <div>
        ...
        <p className="font-inter font-normal text-[17px] md:text-[22px] text-[#717171]">
        ...
        <p className="font-inter font-bold text-[17px] md:text-[22px] text-[#717171] mt-[20px]">
          How to Join:
        </p>

        <ol type="1" className="list-decimal sm:list-decimal md:list-decimal">
          <li className="font-inter font-normal text-[17px] md:text-[22px] text-[#717171]">
            <span className="font-inter font-bold text-[17px] md:text-[22px] text-[#717171]">
              Download the App:{" "}
            </span>
        ...
        <p className="font-inter mt-[20px] font-normal text-[17px] md:text-[22px] text-[#717171]">
        ...
        <button className="bg-[#164C28] py-[16px] md:py-[30px] px-[38px] md:px-[100px] text-white mt-[38px] sm:mt-[10px] font-inter font-medium md:text-[25px] text-[15px] rounded-[5px] hover:shadow-2xl">
          Register
        </button>
      </div>
    </div>
